...
- (id)initWithFrame:(CGRect)frame buttonImages:(NSArray *)imageArray
{
    ...
    self.frame = CGRectMake(0, IS_IOS7?(self.frame.origin.y + 20):self.frame.origin.y , self.frame.size.width, self.frame.size.height);
    if (self)
	{
//        self.backgroundColor = [[YTUserHelper share] colorFromHexRGB:@"f5f5f5"];
        selectbtn = NO;
        firstBtn = NO;
